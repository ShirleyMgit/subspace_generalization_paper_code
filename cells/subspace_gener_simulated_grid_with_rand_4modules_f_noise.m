...
v_noise2 = [v_noise, fliplr(v_noise)];

figure(11)
subplot(1,3,1)
plot(v_noise, auc_within_mean(:, 1), 'k', 'LineWidth', 2)
hold on
fill(v_noise2, [auc_within_mean(:, 1)' + auc_within_std(:, 1)' , fliplr(auc_within_mean(:, 1)' - auc_within_std(:, 1)')], 'k','FaceAlpha',0.3)
hold on
plot(v_noise, auc_between_mean(:, 1), 'g', 'LineWidth', 2)
hold on
fill(v_noise2, [auc_between_mean(:, 1)' + auc_between_std(:, 1)' , fliplr(auc_between_mean(:, 1)' - auc_between_std(:, 1)')], 'g','FaceAlpha',0.3)
hold on
plot(v_noise, auc_within_mean(:, 2), '-.k', 'LineWidth', 2)
hold on
fill(v_noise2, [auc_within_mean(:, 2)' + auc_within_std(:, 2)' , fliplr(auc_within_mean(:, 2)' - auc_within_std(:, 2)')], 'k','FaceAlpha',0.3)
hold on
plot(v_noise, auc_between_mean(:, 2), '-.g', 'LineWidth', 2)
hold on
fill(v_noise2, [auc_between_mean(:, 2)' + auc_between_std(:, 2)' , fliplr(auc_between_mean(:, 2)' - auc_between_std(:, 2)')], 'g','FaceAlpha',0.3)
ylabel('AUC')
xlabel('noise amplitude')
ylim([0.5, 1])
subplot(1,3,2)
plot(v_noise, grid_effect_mean(:, 1), 'b', 'LineWidth', 2)
hold on
fill(v_noise2, [grid_effect_mean(:, 1)' + grid_effect_std(:, 1)', fliplr(grid_effect_mean(:, 1)' - grid_effect_std(:, 1)')], 'b','FaceAlpha',0.3)
hold on
plot(v_noise, grid_effect_mean(:, 2), '-.k', 'LineWidth', 2)
hold on
fill(v_noise2, [grid_effect_mean(:, 2)' + grid_effect_std(:, 2)', fliplr(grid_effect_mean(:, 2)' - grid_effect_std(:, 2)')], 'k','FaceAlpha',0.3)
ylabel('AUC_{within - between}')
xlabel('noise amplitude')
ylim([-0.25, 0.25])
subplot(1,3,3)
plot(v_noise, p_val_effect_mean(:, 1), 'b', 'LineWidth', 2)
hold on
fill(v_noise2, [p_val_effect_mean(:, 1)' + p_val_effect_std(:, 1)', fliplr(p_val_effect_mean(:, 1)' - p_val_effect_std(:, 1)')], 'b', 'FaceAlpha',0.3)
hold on
plot(v_noise, p_val_effect_mean(:, 2), '-.k', 'LineWidth', 2)
hold on
fill(v_noise2, [p_val_effect_mean(:, 2)' + p_val_effect_std(:, 2)', fliplr(p_val_effect_mean(:, 2)' - p_val_effect_std(:, 2)')], 'k', 'FaceAlpha',0.3)
